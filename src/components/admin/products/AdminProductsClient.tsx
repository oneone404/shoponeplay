...
export default function AdminProductsClient({
  ...
  subtitle = "Quản lý toàn bộ danh sách sản phẩm và kho hàng",
  showTypeFilter = true,
          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-secondary/50 text-[10px] uppercase tracking-widest text-muted-foreground border-b border-border">
              <tr>
                ...
                {showUploader && <th className="px-6 py-4 font-bold text-left">Người đăng</th>}
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[10px] text-muted-foreground font-medium uppercase truncate max-w-[200px]">ID: {product.id.slice(-8)}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  {showUploader && (
                    <td className="px-6 py-4 text-left">
                      <div className="flex flex-col">
                        <span className="font-bold text-foreground text-xs">{product.uploader.name || "Admin"}</span>
                        <span className={cn(
                          "text-[9px] font-bold uppercase",
                          product.uploader.role === "ADMIN" ? "text-rose-500" : "text-blue-500"
                        )}>
