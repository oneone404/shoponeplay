        ...
        <div className="p-4 border-b border-border flex items-center justify-between bg-secondary/10">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              disabled={loading}
              onClick={handleSave}
              className="w-8 h-8 flex items-center justify-center bg-primary/10 text-primary border border-primary/20 rounded-lg hover:bg-primary/20 transition-all disabled:opacity-50"
              title="Lưu cấu hình"
            >
        ...
        <div className="p-4 border-b border-border flex items-center justify-between bg-blue-500/5">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="px-3 py-1.5 bg-white text-muted-foreground border border-border rounded-lg text-[10px] font-bold uppercase tracking-widest hover:bg-secondary/50 transition-all flex items-center space-x-2 disabled:opacity-50"
            >
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center bg-primary/10 text-primary border border-primary/20 rounded-lg hover:bg-primary/20 transition-all"
              title="Lưu Card Gateway"
            >
